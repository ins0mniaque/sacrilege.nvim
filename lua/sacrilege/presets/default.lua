...
function M.leftmouse()
    ...
    elseif location.foldtoggle    then print('LeftMouse: Fold toggle')
    elseif location.foldseparator then print('LeftMouse: Fold separator')
...
function M.rightmouse()
    ...
    elseif location.foldtoggle    then print('RightMouse: Fold toggle')
    elseif location.foldseparator then print('RightMouse: Fold separator')
